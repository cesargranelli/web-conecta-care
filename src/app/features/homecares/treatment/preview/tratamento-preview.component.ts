...
import { StatusAtendimento } from 'src/app/core/models/status-atendimento.class';
...
import { AtendimentoPreview } from 'src/app/features/homecares/models/atendimento-preview.model';
