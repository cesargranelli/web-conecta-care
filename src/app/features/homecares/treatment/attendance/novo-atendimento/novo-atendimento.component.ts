...
import { Grupo } from 'src/app/core/models/grupo.class';
import { Modelo } from 'src/app/core/models/modelo.class';
import { Profissional } from 'src/app/core/models/profissional.class';
import { StatusAtendimento } from 'src/app/core/enums/status-atendimento.enum';
import { AtendimentoAdicionar } from 'src/app/features/homecares/models/atendimento-adicionar.model';
import { AtendimentoEndereco } from 'src/app/features/homecares/models/atendimento-endereco.model';
import { AtendimentoRecorrencia } from 'src/app/features/homecares/models/atendimento-recorrencia.model';
import { Diaria } from 'src/app/features/homecares/models/diaria.model';
import { SituacaoAtendimento } from 'src/app/features/homecares/models/situacao-atendimento.model';
import { TipoAtendimento } from 'src/app/features/homecares/models/tipo-atendimento.model';
import { AtendimentoService } from 'src/app/features/homecares/services/atendimento.service';
import { TratamentoStorageService } from 'src/app/features/homecares/services/tratamento-storage.service';
