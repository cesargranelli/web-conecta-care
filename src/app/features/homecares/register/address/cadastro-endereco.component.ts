...
import { EnderecoService } from 'src/app/features/homecares/services/endereco.service';
...
import { FormEnderecoComponent as FormEnderecoHomecareComponent } from 'src/app/features/homecares/shared/components/forms/address/form-endereco.component';

declare var jQuery: any;

@Component({
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, FormsModule, RouterModule, NgxMaskDirective, NgxMaskPipe, FormEnderecoHomecareComponent],
...
export class CadastroEnderecoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.linkBotaoVoltar = `homecares/${this.valid.id}/register/homecare`;
  ...
  private navigate(endereco: EnderecoHomeCare) {
    setTimeout(() => {
      ...
      this._router.navigateByUrl(`homecares/${this.valid.id}/register/contato`);
