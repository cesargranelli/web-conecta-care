...
import {Conselho} from 'src/app/core/models/conselho.class';
import {Estado} from 'src/app/core/models/estado.class';
import {Transporte} from 'src/app/core/models/transporte.class';
import {Role} from 'src/app/core/enums/role.enum';
import {CadastroProfissionaisService} from 'src/app/core/services/cadastro-profissionais.service';
import {CarreiraService} from 'src/app/core/services/carreira.service';
  ...
  onSubmit() {
    ...
    this._service.save(this.carreira).subscribe(response => {
      setTimeout(() => {
        ...
        this._router.navigateByUrl(`profissionais/${this._dadosLocalStorage.id}/profile`);
        Swal.fire({
          position: 'center',
          icon: 'success',
