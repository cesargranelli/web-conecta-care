        ...
        setTimeout(() => {
          if (valid != null) {
            ...
            switch (valid.role) {
              ...
              case Role.Homecare:
                this._validService.setValid(valid);
                this._router.navigateByUrl(`homecares/${valid.id}/register/homecare`);
                break;
              case Role.PlanoSaude:
                this._validService.setValid(valid);
                this._router.navigateByUrl(`planos-saude/${valid.id}/register/plano-saude`);
                break;
              case Role.Paciente:
                valid.modulo = Modulo.Paciente;
                this._validService.setValid(valid);
                this._router.navigateByUrl(`pacientes/${valid.id}/register/informacoes-gerais`);
                break;
              default:
